...
我是一个热爱探索和分享的技术爱好者，持续关注 **大模型、AI Native、云原生、AI Infra、具身智能、科技数码**等前沿技术领域。在这里，我会记录自己的学习心得、技术实践以及对行业的一些思考。
...
### xxxx源头防控关键技术及应用（国家重点研发计划）
- **时间**：2025.05-2026.06
- **职责**：参与网站搭建、国产化部署、卫片下载、报告用图绘制、数值模型、HPC计算资源等技术支持
